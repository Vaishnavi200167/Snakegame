...
food = turtle.Turtle()  # added parentheses
food.speed(0)
food.shape("square")
food.color("red")
food.fillcolor("blue")
...
sb.ht()
sb.goto(-250,250)
sb.write("Score:0  |  Highest Score:0")  # to print the the score on the screen for the first step

# creating a function for moving in all directions
def moveUp():
...
while True:
    ...
    if head.distance(food) < 20:
        ...
        body = turtle.Turtle()
        body.speed(0)  # added argument
        body.penup()
        body.shape("square")
        body.color("red")  # corrected typo
        bodies.append(body)  # append the new in the list
